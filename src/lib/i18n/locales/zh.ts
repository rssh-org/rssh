...
const zh: Messages = {
  ...
  "ai.web_tool.search.title": "网页搜索",
  "ai.web_tool.fetch.title": "网页读取",
  "ai.web_tool.status.running": "进行中",
  "ai.web_tool.status.completed": "已完成",
  "ai.web_tool.status.failed": "失败",
  "ai.web_tool.target_unavailable": "输入不可用",
  "ai.web_tool.search.completed": "找到 {count} 条结果 · {duration}ms",
  "ai.web_tool.fetch.completed": "已读取 {size}{truncated}",
  "ai.web_tool.fetch.truncated": " · 内容已截断",
  "ai.web_tool.error.invalid_input": "工具输入无效。",
  "ai.web_tool.error.not_allowed": "请求被网页访问策略拦截。",
  "ai.web_tool.error.unavailable": "远程服务或网页暂时不可用。",
  "ai.web_tool.error.interrupted": "会话已在请求完成前结束。",

...
const en = {
  ...
  "ai.web_tool.search.title": "Web search",
  "ai.web_tool.fetch.title": "Web page",
  "ai.web_tool.status.running": "Running",
  "ai.web_tool.status.completed": "Done",
  "ai.web_tool.status.failed": "Failed",
  "ai.web_tool.target_unavailable": "Input unavailable",
  "ai.web_tool.search.completed": "Found {count} results · {duration}ms",
  "ai.web_tool.fetch.completed": "Read {size}{truncated}",
  "ai.web_tool.fetch.truncated": " · content truncated",
  "ai.web_tool.error.invalid_input": "The tool received invalid input.",
  "ai.web_tool.error.not_allowed": "The request was blocked by the web access policy.",
  "ai.web_tool.error.unavailable": "The remote service or page is unavailable.",
  "ai.web_tool.error.interrupted": "The session ended before this request completed.",
  ...
  "ai.audit.summary.web_search_completed": "Searched web via {provider}: {query} ({count} results, {dur}ms)",

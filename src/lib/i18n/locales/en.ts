...
const en = {
  ...
  "settings.shell.command_block_prompt_redact_desc": "Recognize the shell prompt on each command block's first row and replace it when copying as text or image. Enter-based block boundaries are unchanged.",
